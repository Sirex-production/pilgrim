...
namespace Support
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""Run"",
                    ""type"": ""Button"",
                    ""id"": ""24ff2069-ada0-4782-94de-9f9978c54a57"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""3b175c70-f439-4318-a638-225200194fc6"",
                    ""path"": ""<Keyboard>/j"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""4d5d3031-7e96-4a92-bc78-eda9bba00153"",
                    ""path"": ""<Keyboard>/shift"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": []
        ...
        private List<IComicsActions> m_ComicsActionsCallbackInterfaces = new List<IComicsActions>();
        ...
        public struct ComicsActions
        {
            ...
            public void AddCallbacks(IComicsActions instance)
            {
                if (instance == null || m_Wrapper.m_ComicsActionsCallbackInterfaces.Contains(instance)) return;
                m_Wrapper.m_ComicsActionsCallbackInterfaces.Add(instance);
            ...
            private void UnregisterCallbacks(IComicsActions instance)
            {
                @Next.started -= instance.OnNext;
                @Next.performed -= instance.OnNext;
                @Next.canceled -= instance.OnNext;
            ...
            public void RemoveCallbacks(IComicsActions instance)
            {
                if (m_Wrapper.m_ComicsActionsCallbackInterfaces.Remove(instance))
                    UnregisterCallbacks(instance);
            }

            public void SetCallbacks(IComicsActions instance)
            {
                foreach (var item in m_Wrapper.m_ComicsActionsCallbackInterfaces)
                    UnregisterCallbacks(item);
                m_Wrapper.m_ComicsActionsCallbackInterfaces.Clear();
                AddCallbacks(instance);
            }
        }
